...
#
# Script generated by Vivado on Mon May 27 22:56:10 +0530 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : AXI_AES_test.sh
...
#
# Usage        : AXI_AES_test.sh
#                AXI_AES_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AXI_AES_test.sh [-reset_run]
#                AXI_AES_test.sh [-reset_log]
#                AXI_AES_test.sh [-help]
#
...
#                script (type 'AXI_AES_test.sh -help' for more information).
#
...
# script info
echo -e "AXI_AES_test.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AXI_AES_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/ec67/hdl" +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/6b2b/hdl" +incdir+"C:/Xilinx_2/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/ec67/hdl" +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/6b2b/hdl" +incdir+"C:/Xilinx_2/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/ec67/hdl" +incdir+"../../../../AES_Encryption.gen/sources_1/bd/AXI_AES_test/ipshared/6b2b/hdl" +incdir+"C:/Xilinx_2/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AXI_AES_test xil_defaultlib.glbl -o AXI_AES_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AXI_AES_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AXI_AES_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AXI_AES_test_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AXI_AES_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AXI_AES_test.sh [-help]\n\
Usage: AXI_AES_test.sh [-step]\n\
Usage: AXI_AES_test.sh [-lib_map_path]\n\
Usage: AXI_AES_test.sh [-reset_run]\n\
Usage: AXI_AES_test.sh [-reset_log]\n\
Usage: AXI_AES_test.sh [-keep_index]\n\
Usage: AXI_AES_test.sh [-noclean_files]\n\n\
