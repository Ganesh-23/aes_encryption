...
#
# Script generated by Vivado on Thu May 30 00:16:15 +0530 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : test_deign.sh
...
#
# Usage        : test_deign.sh
#                test_deign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test_deign.sh [-reset_run]
#                test_deign.sh [-reset_log]
#                test_deign.sh [-help]
#
...
#                script (type 'test_deign.sh -help' for more information).
#
...
# script info
echo -e "test_deign.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test_deign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../AES_Encryption.gen/sources_1/bd/test_deign/ipshared/ec67/hdl" +incdir+"../../../../AES_Encryption.gen/sources_1/bd/test_deign/ipshared/6b2b/hdl" +incdir+"C:/Xilinx_2/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../AES_Encryption.gen/sources_1/bd/test_deign/ipshared/ec67/hdl" +incdir+"../../../../AES_Encryption.gen/sources_1/bd/test_deign/ipshared/6b2b/hdl" +incdir+"C:/Xilinx_2/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.test_deign xil_defaultlib.glbl -o test_deign_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./test_deign_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key test_deign_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc test_deign_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test_deign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test_deign.sh [-help]\n\
Usage: test_deign.sh [-step]\n\
Usage: test_deign.sh [-lib_map_path]\n\
Usage: test_deign.sh [-reset_run]\n\
Usage: test_deign.sh [-reset_log]\n\
Usage: test_deign.sh [-keep_index]\n\
Usage: test_deign.sh [-noclean_files]\n\n\
